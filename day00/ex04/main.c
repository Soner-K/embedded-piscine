...
/*   Updated: 2025/03/04 17:54:31 by sokaraku         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * @param type The type of action to do `INCREMENT`, `DECREMENT` or `PRINT`
 * @returns The new value.
 */
void	doAction(int8_t *value, short action)
{
	if (action == INCREMENT)
